...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/beat/resources/css/mainSlide/dragdealer.css?ver=1" />
		...
		<section class="img-dragger img-dragger-large dragdealer">
			<div class="handle">
				...
				<div class="slide" data-content="content-2">
					<div class="img-wrap">
						<img src="/beat/resources/image/mainSlide/2.jpg" alt="img2" />
					</div>
					<h2>
						Round Table <span>King Arthur's creative team techniques</span>
					</h2>
					<button class="content-switch">Read more</button>
				</div>
				<div class="slide" data-content="content-3">
					<div class="img-wrap">
						<img src="/beat/resources/image/mainSlide/3.jpg" alt="img3" />
					</div>
					<h2>
						Taking Sneezes <span>Nothing is out there&mdash;let's try
							again</span>
					</h2>
					<button class="content-switch">Read more</button>
				</div>
				<div class="slide" data-content="content-4">
					<div class="img-wrap">
						<img src="/beat/resources/image/mainSlide/4.jpg" alt="img4" />
					</div>
					<h2>
						Heavy Talks <span>Heated conversations in the back yard</span>
					</h2>
					<button class="content-switch">Read more</button>
				</div>
				<div class="slide" data-content="content-5">
					<div class="img-wrap">
						<img src="/beat/resources/image/mainSlide/5.jpg" alt="img5" />
					</div>
					<h2>
						Mountain Sun <span>Crazy nature and other weather ideas</span>
					</h2>
					<button class="content-switch">Read more</button>
				</div>
				<div class="slide" data-content="content-6">
					<div class="img-wrap">
						<img src="/beat/resources/image/mainSlide/6.jpg" alt="img6" />
					</div>
					<h2>
						Beloved Mother <span>Decomposing fruits and burning houses</span>
					</h2>
					<button class="content-switch">Read more</button>
				</div>
				<div class="slide" data-content="content-7">
					<div class="img-wrap">
						<img src="/beat/resources/image/mainSlide/7.jpg" alt="img7" />
					</div>
					<h2>
						Kale <i>&amp;</i> Karen <span>Only kale could make her
							happy</span>
					</h2>
					<button class="content-switch">Read more</button>
				</div>
				<div class="slide" data-content="content-8">
					<div class="img-wrap">
						<img src="/beat/resources/image/mainSlide/8.jpg" alt="img8" />
					</div>
					<h2>
						Happiness <span>On self-sufficient homes and pets</span>
					</h2>
					<button class="content-switch">Read more</button>
				</div>
			</div>
